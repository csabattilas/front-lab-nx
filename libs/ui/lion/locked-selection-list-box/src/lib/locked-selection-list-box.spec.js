...
import { LockedSelectionListBox } from './locked-selection-list-box.js';
...
describe('LockedSelectionListBox', () => {
  ...
  beforeEach(async () => {
    if (!customElements.get('locked-selection-list-box-test')) {
      customElements.define(
        'locked-selection-list-box-test',
        LockedSelectionListBox
      );
    }

    element = await fixture(html`
      <locked-selection-list-box-test answer="option1">
